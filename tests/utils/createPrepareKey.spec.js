...
describe('createPrepareKey', () => {
  it('returns equal keys for equal objects with different property orders', () => {
    const objA = { a: 'a', b: 'b' };
    const objB = { a: 'a', b: 'b' };
    const arrayA = [1, 2, 3];
    const arrayB = [1, 2, 3];
  ...
  it('returns different keys for different componentId', () => {
  ...
  it('returns different keys for different props', () => {
    const prepareKeyA = createPrepareKey('Foo', [1, 2, 3]);
    const prepareKeyB = createPrepareKey('Foo', [1, 0, 3]);
    expect(prepareKeyA).not.toBe(prepareKeyB);
  });
  it('returns different keys for different prop orders', () => {
    const prepareKeyA = createPrepareKey('Foo', [1, 2, 3]);
